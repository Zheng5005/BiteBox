...
\restrict d4IHkaHvvkPRfZGf4Ea1bUC5aGznZGGLdDp1uDwRSpH77XdqxqR6PHvDJ2qtVY1
...
--
-- Name: cookbook_recipes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.cookbook_recipes OWNER TO postgres;

--
-- Name: cookbook_recipes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.cookbook_recipes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.cookbook_recipes_id_seq OWNER TO postgres;

--
-- Name: cookbook_recipes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.cookbook_recipes_id_seq OWNED BY public.cookbook_recipes.id;
...
ALTER SEQUENCE public.cookbooks_id_seq OWNER TO postgres;
...
--
-- Name: recipe_views; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: recipe_views_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.recipe_views_id_seq OWNER TO postgres;

--
-- Name: recipe_views_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: cookbook_recipes id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cookbook_recipes ALTER COLUMN id SET DEFAULT nextval('public.cookbook_recipes_id_seq'::regclass);
...
--
-- Name: recipe_views id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: cookbook_recipes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cookbook_recipes (id, cookbook_id, recipe_id, added_at, notes) FROM stdin;
1	1	4	2026-03-21 15:56:46.443126	
\.
...
COPY public.cookbooks (id, user_id, name, description, is_public, created_at, updated_at) FROM stdin;
1	6	My cookbok	this is my cookbook (Tom Martin)	t	2026-03-21 15:56:39.579531	2026-03-21 15:56:39.579531
\.
...
1	6	9	2026-02-14 13:13:07.167517
2	6	1	2026-02-14 13:13:12.959115
3	6	2	2026-02-14 13:13:16.263052
4	6	4	2026-03-21 15:55:56.847168
\.


--
-- Data for Name: recipe_views; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.recipe_views (id, recipe_id, user_id, created_at) FROM stdin;
1	4	\N	2026-03-21 15:42:48.029592
2	4	\N	2026-03-21 15:42:48.032132
3	4	6	2026-03-21 15:55:55.627214
4	4	6	2026-03-21 15:55:55.637908
5	7	6	2026-03-21 15:56:03.970818
6	7	6	2026-03-21 15:56:03.975081
7	1	6	2026-03-21 15:56:06.586267
8	1	6	2026-03-21 15:56:06.58997
9	4	6	2026-03-21 15:56:09.061656
10	4	6	2026-03-21 15:56:09.06529
11	3	6	2026-03-21 15:56:11.929953
12	3	6	2026-03-21 15:56:11.932636
13	1	6	2026-03-21 15:56:14.089912
14	1	6	2026-03-21 15:56:14.098846
15	4	6	2026-03-21 15:56:43.161977
16	4	6	2026-03-21 15:56:43.16513
\.
...
--
-- Name: cookbook_recipes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.cookbook_recipes_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.cookbooks_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.recipe_likes_id_seq', 4, true);


--
-- Name: recipe_views_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.recipe_views_id_seq', 16, true);
...
--
-- Name: cookbook_recipes cookbook_recipes_cookbook_id_recipe_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cookbook_recipes cookbook_recipes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipe_views recipe_views_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_cookbook_recipes_cookbook; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_cookbook_recipes_cookbook ON public.cookbook_recipes USING btree (cookbook_id);


--
-- Name: idx_cookbook_recipes_recipe; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_cookbook_recipes_recipe ON public.cookbook_recipes USING btree (recipe_id);


--
-- Name: idx_cookbooks_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_cookbooks_user ON public.cookbooks USING btree (user_id);
...
CREATE INDEX idx_views_recipe ON public.recipe_views USING btree (recipe_id);
...
CREATE INDEX idx_views_user ON public.recipe_views USING btree (user_id);
...
--
-- Name: cookbook_recipes cookbook_recipes_cookbook_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cookbook_recipes cookbook_recipes_recipe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cookbooks cookbooks_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cookbooks
    ADD CONSTRAINT cookbooks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: recipe_views recipe_views_recipe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipe_views recipe_views_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict d4IHkaHvvkPRfZGf4Ea1bUC5aGznZGGLdDp1uDwRSpH77XdqxqR6PHvDJ2qtVY1
